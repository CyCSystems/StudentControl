...
public class BuscarAlumno extends javax.swing.JDialog {
    ...
    private void CargarTabla(){
        ...
        modelo = coordinador.listaAlumnos();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Busqueda Alumno"));
    ...
    private void TblFiltroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TblFiltroMouseClicked
        ...
        if(evt.getClickCount() == 2){
            if("".equals(Alumno)){
                JOptionPane.showMessageDialog(null, "Debe Seleccionar Un Alumno", "Estudent Control 1.2", JOptionPane.INFORMATION_MESSAGE);
            }else{
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        if("".equals(Alumno)){
            JOptionPane.showMessageDialog(null, "Debe Seleccionar Un Alumno", "Estudent Control", JOptionPane.INFORMATION_MESSAGE);
        }else{
            this.setVisible(false);
        }
