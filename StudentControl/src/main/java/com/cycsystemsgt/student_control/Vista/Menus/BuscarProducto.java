...
public class BuscarProducto extends javax.swing.JDialog {
    ...
    private void CargarTabla(){
        ...
        modelo = coordinador.obtenerProductos(modelo);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED), "Buscar Producto"));
        ...
        TblFiltro.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Producto", "Existencias", "Categoria", "Estado"
            }
        ));
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        if(codigo == 0){
            JOptionPane.showMessageDialog(null, "Debe Seleccionar un producto para continuar", "Estudent Control", JOptionPane.INFORMATION_MESSAGE);
        }else{
    ...
    private void TblFiltroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TblFiltroMouseClicked
        ...
        codigo = Integer.parseInt(TblFiltro.getValueAt(row, 0).toString());
