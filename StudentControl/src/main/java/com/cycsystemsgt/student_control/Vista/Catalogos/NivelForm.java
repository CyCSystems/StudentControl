 ...
 * @author angel
 */
public class NivelForm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Administracion de Niveles Academicos");
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        btnModificar.setEnabled(false);
        tblNivel.setEnabled(false);
    }//GEN-LAST:event_btnNuevoActionPerformed

    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if(!txtNivel.getText().trim().equals("")){
            Nivel Nivel = new Nivel();
            boolean Resultado = false;
            Nivel.setIdNivel(Integer.parseInt("".equals(txtCodigo.getText()) ? "0" : txtCodigo.getText()));
            Nivel.setDescripcion(txtNivel.getText());
            Nivel.setEstado((cbEstado.getSelectedIndex() == 0));
            if(ModificandoNivel == false){
                if(cbEstado.getSelectedIndex() != -1){                
                    if(coordinador.registrarNivel(Nivel) == true){
                       Resultado = true;
                    }else{
                        JOptionPane.showMessageDialog(null, "Error: Guardando Nivel intente de nuevo\nsí persiste el error comuniquese con el administrador", "Student Control", JOptionPane.ERROR_MESSAGE);
                    }
                }else{
                    Resultado = false;
                    JOptionPane.showMessageDialog(null, "Error: Debe elegir el estado del nivel", "Student Control", JOptionPane.ERROR_MESSAGE);
                }
            }else if(ModificandoNivel == true){
                if(coordinador.modificarNivel(Nivel) == true){
                    Resultado = true;
                }else{
                    Resultado = false;
                    JOptionPane.showMessageDialog(null, "Error: Guardando Nivel intente de nuevo\nsí persiste el error comuniquese con el administrador", "Student Control", JOptionPane.ERROR_MESSAGE);
            ...
            if(Resultado == true){
                 JOptionPane.showMessageDialog(null, "Nivel guardado exitosamente", "Student Control", JOptionPane.INFORMATION_MESSAGE);
                desactivarCampos();
                limpiarCampos();
                ...
                btnModificar.setEnabled(false);
                tblNivel.setEnabled(true);
                ModificandoNivel = false;
            }        
        }else{
            JOptionPane.showMessageDialog(null, "Debe especificar la descripcion del nivel", "Student Control", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void tblNivelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblNivelMouseClicked
        int row = tblNivel.getSelectedRow();
        txtCodigo.setText(tblNivel.getValueAt(row, 0).toString());
        txtNivel.setText(tblNivel.getValueAt(row, 1).toString());
        cbEstado.setSelectedIndex(tblNivel.getValueAt(row, 2) == "Activo" ? 0 : 1);
        btnGuardar.setEnabled(false);
        btnCancelar.setEnabled(true);
        btnNuevo.setEnabled(false);
    ...
    public javax.swing.JTable tblNivel;
